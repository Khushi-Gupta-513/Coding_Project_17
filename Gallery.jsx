...
/**
 * Implemented tour fetching and rendering:
 * - Fetch data from API and handle loading and error states.
 * - Render tours dynamically with map().
 * - Added "Not Interested" button to remove tours.
 * - Implemented "Read More"/"Show Less" toggle for descriptions.
 */
